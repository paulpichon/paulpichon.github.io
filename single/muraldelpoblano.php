...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE | Diseño Web | El mural del poblano</title>
	...
	<body class="">
		<main>
			<header class="codrops-header">
				...
				<p class="float-left">El mural del poblano<p>
			...
			<section class="seccion section--intro">
				<div class="container">
					<img src="views/img/single/muralpoblanos.jpg" alt=""  style="margin-top: 100px; width: 100%;">
				</div>
			</section><!--/intro-->
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> elmuraldepoblano.com - Diseño Web</p>
				<p class="interval__text"><em>Cliente:</em> Especialidades Españolas</p>
				<p class="interval__text"><em>Trabajo Realizado:</em> Diseño de página web desde, adaptable a dispositivos móviles.</p>
				<p class="interval__text"><em>Año:</em> 2019</p>
				<a href="http://elmuraldelospoblanos.com/" target="blank" class="btn_visitar">Visitar Sitio</a>
