...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE | Diseño Web | La casa del mendrugo</title>
	...
	<body class="">
		<main>
			<header class="codrops-header">
				...
				<p class="float-left">La casa del mendrugo<p>
			...
			<section class="seccion section--intro">
				<div class="container">
					<img src="views/img/single/casaMendrugo.jpg" alt=""  style="margin-top: 100px; width: 100%;">
				</div>
			</section><!--/intro-->
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> casadelmendrugo.com - Diseño Web</p>
				<p class="interval__text"><em>Cliente:</em> La casa del mendrugo</p>
				<p class="interval__text"><em>Trabajo Realizado:</em> Diseño y construcción de página web.</p>
				<p class="interval__text"><em>Año:</em> 2018</p>
				<a href="https://www.casadelmendrugo.com/" target="blank" class="btn_visitar">Visitar Sitio</a>
