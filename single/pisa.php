...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE |  Diseño Web | PISA </title>
	...
	<body class="">
		<main>
			<header class="codrops-header">
				...
				<p class="float-left">PISA Desarrolladora Inmobiliaria<p>
			...
			<section class="seccion section--intro">
				<div class="container">
					<img src="views/img/single/pisa.jpg" alt=""  style="margin-top: 100px; width: 100%;">
				</div>
			</section><!--/intro-->
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> pisavende.com - Diseño Web</p>
				<p class="interval__text"><em>Cliente:</em> PISA Desarrolladora Inmobiliaria</p>
				<p class="interval__text"><em>Trabajo Realizado:</em> Construcción de página web a partir de un Wireframe.</p>
				<p class="interval__text"><em>Año:</em> 2018</p>
				<a href="https://www.pisavende.com/" target="blank" class="btn_visitar">Visitar Sitio</a>
