...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE | Diseño Web | Telas Rafa</title>
	...
	<body class="">
		<main>
			<header class="codrops-header">
				...
				<p class="float-left">Telas Rafa<p>
			...
			<section class="seccion section--intro">
				<div class="container">
					<img src="views/img/single/telasRafa.jpg" alt=""  style="margin-top: 100px; width: 100%;">
				</div>
			</section><!--/intro-->
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> telasrafa.com - Diseño Web</p>
				<p class="interval__text"><em>Cliente:</em> Telas Rafa</p>
				...
				<a href="http://telasrafa.com/" target="blank" class="btn_visitar">Visitar Sitio</a>
			...
			<section class="section section--right section--portraits">
				...
				<div class="isolayer isolayer--deco2">
					<ul class="grid">
						...
						<li class="grid__item">
							<a class="grid__link" href="single/casabarroca">
								<img class="grid__img layer" src="views/img/single/casaBarroca.jpg" alt="01" />
								<img class="grid__img layer" src="views/img/single/casaBarroca.jpg" alt="01" />
								<img class="grid__img layer" src="views/img/single/casaBarroca.jpg" alt="01" />
								<img class="grid__img layer" src="views/img/single/casaBarroca.jpg" alt="01" />
