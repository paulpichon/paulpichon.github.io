...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE | Diseño Web | OMNES BUSINESS CENTER </title>
	...
	<body class="">
		<main>
			<header class="codrops-header">
				...
				<p class="float-left">OMNES Business Center<p>
			...
			<section class="seccion section--intro">
				<div class="container">
					<img src="views/img/single/omnes.jpg" alt=""  style="margin-top: 100px; width: 100%;">
				</div>
			</section><!--/intro-->
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> omnesbc.com - Diseño Web</p>
				<p class="interval__text"><em>Cliente:</em> OMNES Business Center</p>
				<p class="interval__text"><em>Trabajo Realizado:</em> Diseño y construcción de página web desde cero, tomando en cuenta la adaptación del portal a todos los dispositivos móviles.</p>
				<p class="interval__text"><em>Año:</em> 2017</p>
				<a href="http://omnesbc.com" target="blank" class="btn_visitar">Visitar Sitio</a>
