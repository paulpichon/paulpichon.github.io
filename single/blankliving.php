...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE |  Diseño Web | Blank Living</title>
	...
	<body class="">
		<main>
			<header class="codrops-header">
				...
				<p class="float-left">Blank Living<p>
			...
			<section class="seccion section--intro">
				<div class="container">
					<img src="views/img/single/blankliving.jpg" alt=""  style="margin-top: 100px; width: 100%;">
				</div>
			</section><!--/intro-->
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> blankliving.mx - Diseño Web</p>
				<p class="interval__text"><em>Cliente:</em> Blank Living</p>
				<p class="interval__text"><em>Trabajo Realizado:</em> Diseño de página web desde cero, pues el cliente contaba con una página, pero, ya utilizaba tecnologías muy atrasadas.</p>
				<p class="interval__text"><em>Año:</em> 2018</p>
				<a href="http://blankliving.mx/" target="blank" class="btn_visitar">Visitar Sitio</a>
			...
			<section class="section section--right section--portraits">
				...
				<div class="isolayer isolayer--deco2">
					<ul class="grid">
						<li class="grid__item">
							<a class="grid__link" href="blankliving">
						...
						<li class="grid__item">
							<a class="grid__link" href="casabarroca">
						...
						<li class="grid__item">
							<a class="grid__link" href="propeninsular">
						...
						<li class="grid__item">
							<a class="grid__link" href="casadelmendrugo">
						...
						<li class="grid__item">
							<a class="grid__link" href="impulso">
						...
						<li class="grid__item">
							<a class="grid__link" href="romers">
						...
						<li class="grid__item">
							<a class="grid__link" href="telasrafa">
						...
						<li class="grid__item">
							<a class="grid__link" href="muraldelpoblano">
