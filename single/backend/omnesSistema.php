...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE | BackEnd | OMNES Business Center</title>
	...
	<body class="">
		<main>
			...
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> omnesbc.com - BackEnd</p>
				<p class="interval__text"><em>Cliente:</em> OMNES Business Center</p>
				<p class="interval__text"><em>Trabajo Realizado:</em> Construcción de administrador de contenido (CMS).</p>
