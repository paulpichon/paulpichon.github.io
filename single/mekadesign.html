...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE |  Diseño Web | MekaDesign</title>
	...
	<body class="">
		<main>
			<header class="codrops-header">
				...
				<p class="float-left">MekaDesign<p>
			...
			<section class="seccion section--intro">
				<div class="container">
					<img src="views/img/single/mekadesign.jpg" alt=""  style="margin-top: 100px; width: 100%;">
				</div>
			</section><!--/intro-->
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> mekadesign.mx - Diseño Web</p>
				<p class="interval__text"><em>Cliente:</em> Meka Design</p>
				<p class="interval__text"><em>Trabajo Realizado:</em> Creación de un espacio dedicado al desarrollo y diseño web.</p>
				<p class="interval__text"><em>Año:</em> 2018-?</p>
				<a href="https://mekadesign.mx/" target="blank" class="btn_visitar">Visitar Sitio</a>
