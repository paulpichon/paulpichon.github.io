...
<html lang="es" class="no-js">
	<head>
		...
		<title>PICHON.SPACE | Diseño Web | Confecciones Romer´s</title>
	...
	<body class="">
		<main>
			<header class="codrops-header">
				...
				<p class="float-left">Confecciones Romer´s<p>
			...
			<section class="seccion section--intro">
				<div class="container">
					<img src="views/img/single/rommers.jpg" alt=""  style="margin-top: 100px; width: 100%;">
				</div>
			</section><!--/intro-->
			<section class="interval">
				<p class="interval__text"><em>Proyecto:</em> confeccionesromers.com.mx - Diseño Web</p>
				<p class="interval__text"><em>Cliente:</em> Confecciones Romer´s</p>
				<p class="interval__text"><em>Trabajo Realizado:</em> Renovación de sitio web, diseño y construcción de página web.</p>
				<p class="interval__text"><em>Año:</em> 2017</p>
				<a href="http://www.confeccionesromers.com.mx" target="blank" class="btn_visitar">Visitar Sitio</a>
